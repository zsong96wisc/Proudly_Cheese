...
class DateManagerTest {
  ...
  public void test002_add_more_farm_records() {
    try {
      ...
      List<Record> reportListIn2013 =
          dm.getAnnualReport(new GregorianCalendar(2013, 1, 1, 0, 0, 0));
      List<Record> reportListIn2014 =
          dm.getAnnualReport(new GregorianCalendar(2014, 1, 1, 0, 0, 0));
